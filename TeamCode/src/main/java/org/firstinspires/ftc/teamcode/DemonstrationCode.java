...
public class DemonstrationCode extends LinearOpMode {
    ...
    double slideSpeed = 1300.0;//2787.625 PP/S is max encoder PP/S of Gobilda 435 rpm motor
    ...
    double motor_reduction = 0.3;//for drivetrain
